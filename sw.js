const CACHE='yar-keshavarz-shell-v24';
const CORE=[
  './','./index.html','./offline/offline-ai.js','./offline/regional-crop-calendar.js','./offline/weather-advisor.js','./offline/agriculture-db.js',
